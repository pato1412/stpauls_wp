...
if( $stm_testimonial_type === 'carousel' ) :
    ...
    <div class="stm-testimonials<?php echo esc_attr( $css_class ); ?>">
        <div class="stm-carousel stm-carousel_type_testimonials<?php echo esc_attr( $carousel_class ); ?>">
                    ...
                    <?php if( has_post_thumbnail() ) : ?>
                        <div class="stm-testimonial__avatar_box">
                            ...
                            <div class="stm-testimonial__author">
                                ...
                                <div class="status">
                                    <?php
                                    $stm_testimonial_status_info = ( ( get_post_meta( get_the_ID(), 'stm_testimonial_status_info', true ) ) ? : 0 );
                                    echo esc_attr( $stm_testimonial_status_info );
                                    ?>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        (function($) {
            "use strict";
            var carouselAutoPlay = <?php echo esc_js( $stm_carousel_autoplay ); ?>,
                ...
                carouselOptions = {
                    ...
                    responsive: {
                        ...
                        767: {
                            items: <?php echo esc_js( $stm_carousel_items ); ?>
                        },
                    },
                    navText : ["<span class='stm-icon stm-icon-arrow-bottom-left'></span>","<span class='stm-icon stm-icon-arrow-top-right'></span>"]
                };
