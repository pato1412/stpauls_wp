						...
						<div class="stm-donation__content">
                            ...
                            <div class="stm-donation__time">
                                ...
                                if( $stm_donation_time_left <= 0 && $stm_donation_progress == 100 ) {
                                    ...
                                    echo esc_html( $stm_donation_time_left ) . '&nbsp;' . esc_html__( 'Days left', 'smarty' );
                                } elseif( $stm_donation_time_left <= 0 && $stm_donation_progress < 100 ) {
                                    esc_html_e( 'No Days left', 'smarty' );
                                }
                                ?>
                            </div>
							...
							<div class="stm-donation__action">
								<?php if( $stm_donation_time_left > 0 ) : ?>
									<a class="stm-btn stm-btn_outline stm-btn_red stm-btn_md stm-btn_icon-right" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Donate Now', 'smarty' ); ?><i class="stm-icon stm-icon-arrow-right"></i></a>
								<?php else : ?>
									<button type="button" class="stm-btn stm-btn_outline stm-btn_red stm-btn_md stm-btn_icon-right stm-btn_disabled"><?php esc_html_e( 'Has been completed', 'smarty' ); ?></button>
								<?php endif; ?>
							</div>
						</div>
					</div>
