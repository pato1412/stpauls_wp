...
<div class="stm-cta<?php echo esc_attr( $cta_classes ); ?> <?php echo esc_attr( trim( $css_class ) ); ?>">
	<div class="stm-cta__content">
		...
		<div class="stm-cta__action">
			...
			<div class="stm-cta__action-body">
				...
				<?php if( $btn_link['url'] ) : ?>
						...
						<?php
							$btn_classes = 'stm-btn stm-btn_outline stm-btn_white stm-btn_md stm-btn_icon-right';
							$btn_ic = '';
							...
							if( $btn_color ) {
								$btn_classes .= ' stm-btn_color_' . esc_attr( $btn_color );
							}
						?>

						<a href="<?php echo esc_url( $btn_link['url'] ); ?>" target="<?php echo esc_attr( $btn_link['target'] ); ?>" class="<?php echo esc_attr( $btn_classes ); ?>"><?php echo esc_html( $btn_link['title'] ); ?><i class="stm-icon stm-icon-arrow-right"></i></a>
        ...
        <?php else: ?>
            <div class="stm-cta__action no_image">

                <div class="stm-cta__action-body">
                    <div class="stm-cta__action-body-info">
                        <h2 class="stm-cta__action-title" <?php echo sanitize_text_field( $title_inline_style ); ?>><?php echo esc_html( $title ); ?></h2>
                        <div class="stm-cta__action-descr" <?php echo sanitize_text_field( $descr_inline_style ); ?>><?php echo wpb_js_remove_wpautop($content, true); ?></div>
                    </div>
                    <?php $btn_link = vc_build_link( $btn_link ); ?>
                    ...
                    <div class="stm-cta__action-btn">
                        ...
                        <?php
                        $btn_classes = 'stm-btn stm-btn_flat stm-btn_md stm-btn_icon-right';
                        $btn_ic = '';
                        ...
                        <a href="<?php echo esc_url( $btn_link['url'] ); ?>" target="<?php echo esc_attr( $btn_link['target'] ); ?>" class="<?php echo esc_attr( $btn_classes ); ?>"><?php echo esc_html( $btn_link['title'] ); ?></a>
