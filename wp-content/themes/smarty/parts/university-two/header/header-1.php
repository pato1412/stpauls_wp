        ...
        <div class="header__content">
                ...
                <?php if( $logo = get_theme_mod('logo') ) : ?>
                    <a href="<?php echo esc_url( home_url('/') ); ?>" class="logo" title="<?php echo bloginfo('name'); ?>">
                        <span class="logo__icon">
                            <img src="<?php echo esc_url( $logo ); ?>" alt="<?php echo esc_attr__('Logo', 'smarty'); ?> width="<?php echo get_theme_mod('logo_width'); ?>"">
                        </span>
                    </a>
                <?php else: ?>
            ...
            <div class="logo-box-blue">
                <?php if( $logo2 = get_theme_mod('logo2') ) : ?>
                    <a href="<?php echo esc_url( home_url('/') ); ?>" class="logo" title="<?php echo bloginfo('name'); ?>">
                        <span class="logo__icon">
                            <img src="<?php echo esc_url( $logo2 ); ?>" alt="<?php echo esc_attr__('Logo', 'smarty'); ?>" width="<?php echo get_theme_mod('logo_width'); ?>">
                        </span>
                    </a>
                <?php else: ?>
